        ...
        <div className="container mx-auto py-12 px-4">
          <Button variant="outline" asChild className="mb-8">
            <Link href="/finances">
              ...
              Back to Financial Guidance
            </Link>
          </Button>
          <div className="text-center py-12">
            <h1 className="text-3xl font-bold mb-4">Finance Guide not found</h1>
            <p className="text-muted-foreground">The finance guide you're looking for doesn't exist.</p>
          </div>
        </div>
      </MainLayout>
    );
